                ...
                <li class="mt-4">
                    <details class="">
                        <summary class="text-lg">
                            <a id="trend" class="flex items-center"  >
                        ...
                        <ul>
                            <li>
                                <a href="/trending/month" class="text-sm">Month</a>
                            </li>
                            <li>
                                <a href="/trending/year" class="text-sm">Year</a>
                            </li>
                            <li>
                                <a href="/trending/all" class="text-sm">All time</a>
                            </li>
                        </ul>
                    </details>
